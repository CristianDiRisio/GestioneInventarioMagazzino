        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            btnVisualizza.Click += (s, args) =>
            {
                ...
                if (inventario.Count > 0)
                {
                    ...
                    {
                        Prodotto prodotto = item.Value;
                        sb.AppendLine($"Nome: {prodotto.Nome}, Quantità: {prodotto.Quantità}, Prezzo: {prodotto.Prezzo:C}");
                    }
            ...
            btnCerca.Click += (s, args) =>
            {
                if (inventario.ContainsKey(TabCerca.Text))
                {
                    ...
                    MessageBox.Show($"Prodotto trovato: Nome: {prodotto.Nome}, Quantità: {prodotto.Quantità}, Prezzo: {prodotto.Prezzo:C}", "Prodotto Trovato", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
